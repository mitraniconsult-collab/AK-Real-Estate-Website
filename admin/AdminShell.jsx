...
const TRANSLATIONS = {
  bg: {
    ...
    // ── ListingsPage ──
    'Manage · Listings':        'Управление · Имоти',
    'The portfolio':            'Портфолио',
    'register.':                'регистър.',
    ...
    'Sale':                     'Продажба',
    'Rent':                     'Наем',
    'Search title, city, area…':'Търси по заглавие, град, район…',
    'Showing':                  'Показани',
    'of':                       'от',
    'Property':                 'Имот',
    'Location':                 'Локация',
    ...
    'Activate':                 'Активирай',
    'Delete':                   'Изтрий',
    'Toggle featured':          'Превключи избран',
    'Table view':               'Изглед таблица',
    'Card view':                'Изглед карти',
    'Nothing to show.':         'Няма резултати.',
    "No listings match the current filters. Adjust your search, or start a new listing — we'll keep it as a draft until you're ready to publish.":
      'Няма имоти, които отговарят на текущите филтри. Промени търсенето или създай нов имот — ще го запазим като чернова, докато стане готов за публикуване.',
    'Delete listing?':          'Да изтрием ли имота?',
    'will be permanently removed.': 'ще бъде изтрит завинаги.',
    'Cancel':                   'Отказ',
    'Confirm':                  'Потвърди',
  },
  en: {
    ...
    'Sale':                     'Sale',
    'Rent':                     'Rent',
    'Search title, city, area…':'Search title, city, area…',
    'Showing':                  'Showing',
    'of':                       'of',
    'Property':                 'Property',
    'Location':                 'Location',
