...
const FOUNDER_IMG = (window.__resources && window.__resources.imgFounder);
    ...
    <section style={{ background: 'var(--ak-bone)', color: 'var(--fg-on-light)',
      ...
      <div style={{ display: 'grid',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 18,
          ...
          <VLabel style={{ color: 'var(--fg-on-light-3)' }}>{t('founder.vlabel')}</VLabel>
        </div>
          ...
          <div style={{ position: 'relative', aspectRatio: '4 / 5',
            ...
            <div style={{ position: 'absolute', left: 18, bottom: 16,
              ...
              <span style={{ fontSize: 10, fontWeight: 500, letterSpacing: '0.28em',
                textTransform: 'uppercase', color: '#fff' }}>{t('founder.imgcap')}</span>
            </div>
          </div>
        ...
        <div style={{ paddingTop: 40 }}>
          <Eyebrow light style={{ marginBottom: 28 }}>{t('founder.eyebrow')}</Eyebrow>
          <h2 style={{
            ...
            {t('founder.title1')} <em style={{ color: 'var(--ak-crimson)', fontStyle: 'italic', fontWeight: 400 }}>{t('founder.titleEm')}</em>
          </h2>
          <div style={{ marginTop: 32, columns: 1, maxWidth: 460 }}>
            ...
            <p style={{ margin: '0 0 18px', fontSize: 16, lineHeight: 1.7,
              fontWeight: 300, color: 'var(--ak-pewter)' }}>
              {t('founder.p2a')}<em style={{ color: 'var(--ak-crimson)', fontStyle: 'italic' }}>{t('founder.p2em')}</em>
            </p>
            ...
            <div style={{ marginTop: 36, display: 'flex', alignItems: 'center', gap: 24 }}>
              <Btn variant="primary">{t('founder.cta')}</Btn>
