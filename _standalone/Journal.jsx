...
const J_IMGS = {
  a: (window.__resources && window.__resources.imgEdInset),
  b: (window.__resources && window.__resources.imgJournA),
  c: (window.__resources && window.__resources.imgJournB),
};

const SOCIAL = [
  (window.__resources && window.__resources.imgSocA),
  (window.__resources && window.__resources.imgSocB),
  (window.__resources && window.__resources.imgSocC),
  (window.__resources && window.__resources.imgSocD),
  (window.__resources && window.__resources.imgSocE),
  (window.__resources && window.__resources.imgSocF),
];
  ...
  return (
    <section style={{ background: 'var(--ak-ink)', color: 'var(--fg)',
      ...
      <header style={{ display: 'flex', alignItems: 'end',
        ...
        <SectionNumeral n="06" label={t('journal.eyebrow')} />
